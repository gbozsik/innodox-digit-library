...
//        author1.setBooks(bookList1);
        ...
        List<User> users = Arrays.asList(
                new User("skovi", "sanyi.kovacs@gmail.com", "Sanyi", "kovács", new Password("pas"), books),
                new User("sferi", "feri.sos@t-online.com", "Feri", "Sós", new Password("pas"), books),
                new User("ktomi", "tamas.kis@gmail.com", "Tomi", "kis", new Password("pas"), books)
        );
